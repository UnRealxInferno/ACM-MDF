...
if (_number == _liveFracture) exitWith {
    ...
    [_patient, "quick_view", LSTRING(surgery_log), [[_medic] call ACEFUNC(common,getName), _surgeryString, toLower _bodyPartString]] call ACEFUNC(medical_treatment,addToLog);
