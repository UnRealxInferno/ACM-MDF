class ACEGVAR(medical_treatment,actions) {
    ...
    class ClosedReduction: CheckFracture {
        ...
        condition = QUOTE((GVAR(enable_fracture)) && ([ARR_4(_medic,_patient,_bodyPart,1)] call FUNC(fractureCheck)));
    ...
    class Incision: BasicBandage {
        ...
        items[] = {"kat_scalpel"};
        consumeItem = 0;
        condition = QUOTE((GVAR(enable_fracture)) && ([ARR_4(_medic,_patient,_bodyPart,5)] call FUNC(openReductionCheck)));
    ...
    class Expose: BasicBandage {
        ...
        items[] = {"kat_retractor"};
        consumeItem = 0;
        condition = QUOTE((GVAR(enable_fracture)) && ([ARR_4(_medic,_patient,_bodyPart,2.1)] call FUNC(openReductionCheck)));
    ...
    class Irrigate: BasicBandage {
        ...
        consumeItem = 1;
        condition = QUOTE((GVAR(enable_fracture)) && ([ARR_4(_medic,_patient,_bodyPart,2.3)] call FUNC(openReductionCheck)));
    ...
    class Clamp: BasicBandage {
        ...
        items[] = {"kat_clamp"};
        consumeItem = 0;
        condition = QUOTE((GVAR(enable_fracture)) && ([ARR_4(_medic,_patient,_bodyPart,3.3)] call FUNC(openReductionCheck)));
    ...
    class OpenReduction: CheckFracture {
        ...
        items[] = {"kat_plate"};
        consumeItem = 1;
        condition = QUOTE((GVAR(enable_fracture)) && ([ARR_4(_medic,_patient,_bodyPart,3.5)] call FUNC(openReductionCheck)));
    ...
    class NPWT: BasicBandage {
        ...
        consumeItem = 0;
        condition = QUOTE((GVAR(enable_fracture)) && ([ARR_3(_medic,_patient,_bodyPart)] call FUNC(canNPWT)));
